...
Örnek: parameters: students.txt output.txt

Note: Program needs input file like inside 'students.txt' format and some output file. The input and outpu file name must be given as a command line argument to program.
Example: parameters: student.txt output.txt
